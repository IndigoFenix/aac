...
--> statement-breakpoint
ALTER TABLE "aac_user_schedules" ADD CONSTRAINT "aac_user_schedules_aac_user_id_aac_users_id_fk" FOREIGN KEY ("aac_user_id") REFERENCES "public"."aac_users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "api_calls" ADD CONSTRAINT "api_calls_prompt_id_prompt_history_id_fk" FOREIGN KEY ("prompt_id") REFERENCES "public"."prompt_history"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "interpretations" ADD CONSTRAINT "interpretations_aac_user_id_aac_users_id_fk" FOREIGN KEY ("aac_user_id") REFERENCES "public"."aac_users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "invite_code_redemptions" ADD CONSTRAINT "invite_code_redemptions_aac_user_id_aac_users_id_fk" FOREIGN KEY ("aac_user_id") REFERENCES "public"."aac_users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "invite_codes" ADD CONSTRAINT "invite_codes_aac_user_id_aac_users_id_fk" FOREIGN KEY ("aac_user_id") REFERENCES "public"."aac_users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "user_aac_users" ADD CONSTRAINT "user_aac_users_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "user_aac_users" ADD CONSTRAINT "user_aac_users_aac_user_id_aac_users_id_fk" FOREIGN KEY ("aac_user_id") REFERENCES "public"."aac_users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_user_aac_users_user_id" ON "user_aac_users" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "idx_user_aac_users_aac_user_id" ON "user_aac_users" USING btree ("aac_user_id");