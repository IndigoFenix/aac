...
export const he = {
  ...
  student: {
    ...
    selectInstitutes: "בחר ארגונים עבור תלמיד זה",
    noInstitutesWarning: "יש להשתייך לפחות לארגון אחד כדי ליצור תלמיד.",
  ...
  students: {
    ...
    addFirst: "הוסף את התלמיד הראשון שלך",
  ...
  landing: {
    ...
    hero: {
      ...
      title: "להחזיר את הזמן לקלינאים. לתת קול לתלמידים.",
    ...
    pillars: {
      ...
      iep: {
        ...
        description: "פלטפורמת AI המנתחת את התקדמות התלמיד ומנסחת יעדים מדויקים באופן אוטומטי. מקצצת עד 50% מזמן התיעוד.",
      },
      aac: {
        label: "תת\"ח (AAC)",
