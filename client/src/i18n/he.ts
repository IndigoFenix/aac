...
export const he = {
    ...
    // Overview Panel
    "overview.title": "לוח בקרה",
    "overview.subtitle": "מעקב אחר התקדמות תלמידים ומועדים קרובים",
    "overview.totalStudents": "סה״כ תלמידים",
    "overview.activeCases": "תיקים פעילים",
    "overview.completedCases": "הושלמו",
    "overview.pendingReview": "ממתינים לאישור",
    "overview.enrolled": "רשומים לתוכנית",
    "overview.fromLastMonth": "+2 מהחודש שעבר",
    "overview.ytd": "מתחילת השנה",
    "overview.attentionNeeded": "דורש תשומת לב",
    "overview.deadlineAlert": "מועדים מתקרבים",
    "overview.daysLeft": "נותרו 7 ימים",
    "overview.deadlineDesc": "ל-{count} תלמידים יש מועדים מתקרבים",
    "overview.reviewBtn": "סקור הכל",
    "overview.chartTitle": "התפלגות לפי שלב",
    "overview.chartSubtitle": "התפלגות תלמידים לפי שלבי התהליך",
    "overview.priorityFocus": "עדיפות גבוהה",
    "overview.priorityDesc": "תלמידים הדורשים תשומת לב מיידית",
    "overview.viewAll": "הצג את כל התלמידים",
    
    // Students Panel
    "students.title": "תלמידים",
    "students.subtitle": "ניהול רשומות תלמידים ומעקב התקדמות",
    "students.searchPlaceholder": "חיפוש תלמידים...",
    "students.filterStatus": "סטטוס",
    "students.filterSchool": "בית ספר",
    "students.foundCount": "נמצאו {count} תלמידים",
    "students.newStudent": "תלמיד חדש",
    "students.idLabel": "ת.ז",
    "students.diagnosisLabel": "אבחנה",
    "students.progressLabel": "התקדמות",
    "students.dueLabel": "תאריך יעד",
    "students.openTala": "פתח תהליך",
    "students.openIEP": "פתח IEP",
    "students.actions": "פעולות",
    "students.editDetails": "ערוך פרטים",
    "students.viewHistory": "הצג היסטוריה",
    "students.archive": "העבר לארכיון",
    "students.all": "הכל",
    "students.active": "פעילים",
    "students.completed": "הושלמו",
    
    // Tala Process (Israel)
    "tala.title": "תהליך תל״א",
    "tala.titleSuffix": " - תהליך תל״א",
    "tala.backButton": "חזרה לתלמידים",
    "tala.nextDeadline": "מועד הבא",
    "tala.share": "שתף",
    "tala.exportPdf": "ייצוא PDF",
    "tala.roadmap": "מפת התהליך",
    "tala.roadmapDesc": "מעקב התקדמות בכל שלב",
    "tala.phaseCurrent": "שלב נוכחי",
    "tala.phase1Title": "הערכה ראשונית",
    "tala.phase2Title": "מטרות ותכנון",
    "tala.phase3Title": "יישום",
    "tala.phase4Title": "סיכום והערכה",
    "tala.inProgress": "בתהליך",
    "tala.phase2Desc": "הגדרת מטרות מדידות ואסטרטגיות התערבות",
    "tala.deadlineLabel": "מועד אחרון",
    "tala.goal1Title": "מטרת תקשורת",
    "tala.goal1Desc": "התלמיד ישפר שפה אקספרסיבית באמצעות מכשיר AAC ברמת דיוק של 80%.",
    "tala.goal2Title": "מטרת אינטראקציה חברתית",
    "tala.goal2Desc": "התלמיד ייזום אינטראקציות עם עמיתים 3 פעמים בכל מפגש.",
    "tala.editGoal": "ערוך מטרה",
    "tala.addGoal": "הוסף מטרה חדשה",
    "tala.lastSaved": "נשמר לאחרונה: לפני 2 דקות",
    "tala.saveDraft": "שמור טיוטה",
    "tala.submitApproval": "הגש לאישור",
    "tala.viewData": "הצג נתונים",
    "tala.locked": "נעול",
    
    // Phase names (translation keys)
    "phase.p1": "הערכה ראשונית",
    "phase.p2": "מטרות ותכנון",
    "phase.p3": "יישום",
    "phase.p4": "סיכום והערכה",
    
    // US IEP Process
    "iep.title": "פיתוח IEP",
    "iep.clinicalModule": "מודול תיעוד קליני",
    "iep.plaafpTitle": "נתוני בסיס PLAAFP",
    "iep.currentPerformance": "ביצועים נוכחיים",
    "iep.impactStatement": "השפעה שלילית",
    "iep.smartGoalTitle": "פיתוח מטרה SMART",
    "iep.smartGoalDesc": "כתיבת מטרות בסיוע AI עם בדיקת תאימות",
    "iep.generateDraft": "יצירת טיוטה",
    "iep.finalizeGoal": "סיום המטרה",
    "iep.complianceTitle": "רשימת תאימות",
    "iep.serviceRecommendation": "המלצת שירות",
    "iep.export": "ייצוא",
    "iep.exportComponent": "ייצוא למסמך IEP",
  };