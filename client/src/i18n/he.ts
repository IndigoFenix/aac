...
export const he = {
  ...
  institute: {
    ...
    // ניהול תלמידים
    addStudent: "הוסף תלמיד",
    addStudentDesc: "בחר תלמיד להוספה למוסד זה.",
    selectStudent: "תלמיד",
    selectStudentPlaceholder: "בחר תלמיד...",
    noAvailableStudents: "כל התלמידים שלך כבר במוסד זה",
    noStudentsHintAdmin: "לחץ על \"הוסף תלמיד\" כדי לשייך תלמידים למוסד זה",
    grade: "שכבת גיל",
    selectGrade: "בחר שכבה...",
    studentIdNumber: "מספר תלמיד",
    studentIdPlaceholder: "מספר זיהוי מוסדי (אופציונלי)",
    add: "הוסף",
    editEnrollment: "ערוך רישום",
    editEnrollmentDesc: "עדכן פרטי רישום התלמיד.",
    removeStudent: "הסר מהמוסד",
    remove: "הסר",
    studentAdded: "התלמיד נוסף",
    studentAddedDesc: "התלמיד נוסף למוסד בהצלחה.",
  ...
  landing: {
    ...
    form: {
      ...
      roles: {
        ...
        supervisor: "פיקוח",
        training: "הדרכה",
        school_administrator: "הנהלת מוסד",
        educator: "הוראה",
  ...
  admin: {
    licenses: {
      title: "רישיונות",
      subtitle: "יצירה וניהול רישיונות למשתמשים ומוסדות.",
      ...
      // Institute
      institute: "מוסד",
      createInstitute: "יצירת מוסד",
      instituteName: "שם מוסד",
      instituteType: "סוג מוסד",
      school: "בית ספר",
      hospital: "בית חולים",
      // Permissions
