...
export const he = {
  ...
  student: {
    ...
    instituteAssignFailed: "התלמיד נוצר אך השיוך לארגון נכשל.",
    warning: "אזהרה",
    grades: {
      pre_k: "גן",
      k: "כיתה א׳",
  ...
  institute: {
    ...
    // ניהול תלמידים
    addStudent: "הוסף תלמיד",
    addStudentDesc: "בחר תלמיד להוספה לארגון זה.",
    selectStudent: "תלמיד",
    selectStudentPlaceholder: "בחר תלמיד...",
    noAvailableStudents: "כל התלמידים שלך כבר בארגון זה",
    noStudentsHintAdmin: "לחץ על \"הוסף תלמיד\" כדי לשייך תלמידים לארגון זה",
    grade: "שכבת גיל",
    selectGrade: "בחר שכבה...",
    studentIdNumber: "מספר תלמיד",
    studentIdPlaceholder: "מספר זיהוי ארגוני (אופציונלי)",
    add: "הוסף",
    editEnrollment: "ערוך רישום",
    editEnrollmentDesc: "עדכן פרטי רישום התלמיד.",
    removeStudent: "הסר מהארגון",
    remove: "הסר",
    studentAdded: "התלמיד נוסף",
    studentAddedDesc: "התלמיד נוסף לארגון בהצלחה.",
    studentUpdated: "התלמיד עודכן",
    studentUpdatedDesc: "פרטי הרישום עודכנו בהצלחה.",
    studentRemoved: "התלמיד הוסר",
    studentRemovedDesc: "התלמיד הוסר מהארגון.",
    confirmRemoveStudent: "להסיר תלמיד מהארגון?",
    confirmRemoveStudentDesc: "תלמיד זה יוסר מהארגון ומכל הכיתות המשויכות.",
    language: "שפה",
  ...
  aacSettings: {
    ...
    noStudent: "לא נבחר תלמיד",
    noStudentDesc: 'בחר תלמיד כדי להגדיר את הגדרות תת"ח שלו.',
    currentStudent: "תלמיד נוכחי",
    genderMale: "זכר",
    genderFemale: "נקבה",
    ...
    customStudentVoice: "קול תלמיד מותאם",
    ...
    interpretationDesc: "עד כמה ה-AI מפרש באגרסיביות את כוונת התלמיד",
    interpNone: "ללא",
    interpMinimal: "מינימלי",
    interpConservative: "שמרני",
    interpCreative: "יצירתי",
    interpAutonomous: "אוטונומי",
    interpNoneDesc: "ללא פרשנות. ה-AI מנהל את הלוח ומדבר, אך לעולם לא מפרש כוונת תלמיד.",
    ...
    interpAutonomousDesc: "אוטונומי. ה-AI מדבר בשם התלמיד באופן יזום בשיחות.",
    // Startup
    ...
    chatBehaviorDesc: "התאם את אופן התגובה של עוזר ה-AI לתלמיד זה",
    systemPrompt: "הנחיית מערכת",
    systemPromptPlaceholder: "הזן הוראות מותאמות לעוזר ה-AI...",
    systemPromptHint: "הנחייה זו מגדירה כיצד עוזר ה-AI מתנהג בעת אינטראקציה עם תלמיד זה.",
    ...
    allowReadProgressDesc: "כאשר מושבת, הבינה המלאכותית לא תוכל לצפות במטרות ויעדים של התלמיד",
    ...
    settingsUpdatedDesc: 'הגדרות תת"ח של התלמיד נשמרו.',
  ...
  landing: {
    ...
    hero: {
      tagline: "הפתרון: פלטפורמה שמבוססת על שני עמודי תווך",
      title: "להחזיר זמן לקלינאים. לתת קול לתלמידים.",
      subtitle: "מערכת משולבת שמאפשרת אוטומציה של תיעוד תל\"א ומסנכרנת יעדי טיפול עם תקשורת דינמית מבוססת בינה מלאכותית.",
      cta: "← הצטרפו לפיילוט האסטרטגי",
      screenshotAlt: "צילום מסך של לוח הבקרה של Aivota",
    },
    pillars: {
      title: "מערכת אחת, שני עמודי תווך",
      subtitle: "הפחתת שחיקת מטפלים וחוסר יעילות באמצעות בינה מלאכותית .",
      iep: {
        label: "מוצר מוביל",
        title: "מנוע אוטומציה לתל\"א",
        description: "פלטפורמת AI בינה מלאכותית שמאפשרת יצירה אוטומטית של תוכניות תל\"א על בסיס נתונים. המערכת מנתחת את התקדמות התלמיד לניסוח יעדים מדויקים, ומפחיתה תיעוד עד 50%.",
      },
      aac: {
        label: "פתרון משלים",
        title: "תת\"ח מבוסס AI בינה מלאכותית",
        description: "כלי תקשורת חכם מהדור הבא, מודע להקשר, שמתיישר אוטומטית עם יעדי ה-תל\"א ומסנכרן בצורה מושלמת בין טיפול לתקשורת יומיומית.",
      },
    },
    founder: {
      label: "מייסד וחזון",
      title: "מומחיות AI ותיקה. משימה אישית עמוקה.",
      bio: "אופר סוחמי הוא מנהל AI ותיק ומנכ\"ל לשעבר של חברת AI ציבורית. כאב לבת עם תסמונת רט, הוא מחויב להחזיר זמן לקלינאים וקול לתלמידים.",
      imageAlt: "אופר סוחמי",
      calloutTitle: "עמידה בחוק הפרטיות הישראלי ובתקני HIPAA ו-FERPA",
      calloutText: "על ידי שילוב תהליך התל\"א עם תת\"ח, הבינה המלאכותית שלנו משפרת תוצאות תלמידים תוך קיצוץ עלויות תפעוליות.",
    },
    testimonial: {
    ...
    pilot: {
      title: "השקת פיילוטים אסטרטגיים בישראל",
      subtitle: "הצטרפו עכשיו!",
    },
    footer: {
      text: "© 2026 Aivota • עמידה בחוק הפרטיות ותקני  HIPAA ו-FERPA • נבנה לעתיד החינוך המיוחד",
      terms: "תנאי שימוש",
