...
export const he = {
  ...
  landing: {
    ...
    hero: {
      tagline: "הפתרון: פלטפורמה דו-עמודית",
      title: "להחזיר זמן לקלינאים. לתת קול לתלמידים.",
      subtitle: "מערכת משולבת שמאפשרת אוטומציה של תיעוד IEP ומסנכרנת יעדי טיפול עם תקשורת דינמית מבוססת בינה מלאכותית.",
      cta: "← הצטרפו לפיילוט האסטרטגי",
      screenshotAlt: "צילום מסך של לוח הבקרה של AiVota",
    },
    pillars: {
      title: "מערכת אחת, שני עמודים",
      subtitle: "הפחתת שחיקת מטפלים וחוסר יעילות מחוזי באמצעות בינה מלאכותית משולבת.",
      iep: {
        label: "מוצר מוביל",
        title: "מנוע אוטומציה ל-IEP",
        description: "פלטפורמת בינה מלאכותית שמאפשרת יצירה אוטומטית של תוכניות IEP מבוססות נתונים. המערכת מנתחת את התקדמות התלמיד לניסוח יעדים מדויקים, ומפחיתה תיעוד בעד 50%.",
      },
      aac: {
        label: "פתרון משלים",
        title: "AAC מבוסס בינה מלאכותית",
        description: "כלי תקשורת חכם מהדור הבא, מודע להקשר, שמתיישר אוטומטית עם יעדי ה-IEP ומסנכרן בצורה מושלמת בין טיפול לתקשורת יומיומית.",
      },
    },
    founder: {
      label: "מייסד וחזון",
      title: "מומחיות AI ותיקה. משימה אישית עמוקה.",
      bio: "אופר סוהמי הוא מנהל AI ותיק ומנכ\"ל לשעבר של חברת AI ציבורית. כאב לבת עם תסמונת רט, הוא מחויב להחזיר זמן לקלינאים וקול לתלמידים.",
      imageAlt: "אופר סוהמי",
      calloutTitle: "מקור אמת תואם HIPAA ו-FERPA",
      calloutText: "על ידי שילוב תהליך ה-IEP עם כלי תקשורת חי, הבינה המלאכותית שלנו משפרת תוצאות תלמידים תוך קיצוץ עלויות תפעוליות.",
    },
    testimonial: {
      quote: "Xahaph משנה את התמונה עבור קלינאיות תקשורת. לטכנולוגיה הזו יש את היכולת להפוך את העבודה שלנו לקלה ולטובה יותר. זה מטורף.",
    ...
    form: {
      ...
      lastName: "שם משפחה",
      email: "דוא\"ל",
      organization: "מחוז חינוכי / ארגון",
      role: "התפקיד שלך",
      ...
      roles: {
        district_administrator: "מנהל מחוז",
        special_education_director: "מנהל חינוך מיוחד",
        speech_language_pathologist: "קלינאי/ת תקשורת",
        educator: "מחנך/ת",
        other: "אחר",
      },
    ...
    pilot: {
      title: "השקת פיילוטים אסטרטגיים בארה\"ב",
      subtitle: "הצטרפו כשותפי עיצוב. בואו נדון איך נוכל להחזיר זמן לקלינאים שלכם.",
    },
    footer: {
      text: "© 2026 AiVota • תואם HIPAA ו-FERPA • נבנה לעתיד החינוך המיוחד",
    },
  },
};