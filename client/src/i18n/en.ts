...
export const en = {
  ...
  student: {
    ...
    countryOther: "Other",
    instituteAssignment: "Institute Assignment",
    currentInstitutes: "Current Institutes",
    assignToInstitute: "Assign to Institute",
    selectInstitute: "Select institute...",
    ...
    instituteAssignFailed: "Student created but institute assignment failed.",
    warning: "Warning",
    grades: {
      1: "1st Grade",
      2: "2nd Grade",
  ...
  institute: {
    ...
    // Student management
    addStudent: "Add Student",
    addStudentDesc: "Select a student to add to this institute.",
    selectStudent: "Student",
    selectStudentPlaceholder: "Select a student...",
    noAvailableStudents: "All your students are already in this institute",
    noStudentsHintAdmin: "Click \"Add Student\" to assign students to this institute",
    grade: "Grade Level",
    selectGrade: "Select grade...",
    ...
    removeStudent: "Remove from Institute",
    remove: "Remove",
    studentAdded: "Student Added",
    studentAddedDesc: "Student has been added to the institute.",
  ...
  classroom: {
    ...
    addMember: "Add Staff",
    addMemberDesc: "Assign an institute member to this classroom.",
    selectMember: "Select Staff Member",
    selectMemberPlaceholder: "Choose a member...",
    noAvailableMembers: "All institute members are already assigned to this classroom.",
