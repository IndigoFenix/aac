...
import { buildTransportObjects, embedLayoutInWorld } from "@shared/world-engine/solver/space3d.js";
import type { GoalTreeGame, TransportNode } from "@shared/world-engine/solver/types.js";
