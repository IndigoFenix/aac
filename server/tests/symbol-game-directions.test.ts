...
} from "@shared/symbol-game/directions.js";
import {
  answerPlaceDirections,
  houseGlyphForColor,
  nearestColorSymbol,
  type PlaceFact,
} from "@shared/symbol-game/town-directions.js";
import { speakDirections } from "@shared/symbol-game/lang/index.js";
import {
  createCreatureWorld,
  projectDialogue,
  selectAct,
...
import type { TownStreets } from "@shared/engine/town/streets.js";
