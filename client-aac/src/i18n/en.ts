...
export const en = {
  ...
  aac: {
    ...
    restaurant: {
      title: "Restaurant",
      companionIntro: "For the companion — find the restaurant, then get its menu.",
      ...
      fetchingMenu: "Getting the menu for {place}…",
      menuUnavailable: "The menu for {place} isn't available right now.",
      dontKnowWhere: "I don't know where we are right now.",
      backToFood: "Something else",
      forCompanion: "For the companion",
  ...
  errors: {
    ...
    INVALID_CAPTURE_REQUEST: "Those photos could not be used. Try again with a clear shot of the menu.",
    INVALID_LOCATION: "We could not read this device's location. Check that location is allowed for this app.",
    INVALID_VENUE_SELECTION: "That restaurant could not be selected. Try choosing it again.",
    MENU_BINDING_REFUSED: "Confirm which restaurant you are in before getting a menu.",
    MENU_CAPTURE_FAILED: "The menu could not be read from those photos. Try again in better light.",
    NO_STUDENT_ACCESS: "You do not have access to this AAC user.",
    STUDENT_NOT_FOUND: "This AAC user could not be found.",
    VENUE_BROWSE_DISABLED: "Looking for somewhere to eat is turned off for this AAC user.",
    VENUE_CONFIRM_FAILED: "That restaurant could not be saved. Please try again.",
    VENUE_MENUS_DISABLED: "Restaurant menus are turned off for this AAC user.",
    VENUE_NOT_FOUND: "That restaurant is no longer available. Choose it again from the list.",
    VENUE_SEARCH_FAILED: "The search for nearby restaurants did not work. Please try again.",
    WEB_MENU_UNAVAILABLE: "No menu could be found online for this restaurant. Photograph it instead.",
  },
