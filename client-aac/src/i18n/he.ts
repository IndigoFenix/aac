...
export const he: Translations = {
  ...
  devices: {
    ...
    limitFullDesc: "כל משבצות המכשירים של משתמש AAC זה ({limit}) תפוסות על ידי מכשירים אחרים. הסירו מכשיר מהרשימה כדי לפנות מקום, או פנו לקלינאי.",
    overLimitDesc: "למשתמש AAC זה {count} מכשירים רשומים, אך כעת מותרים רק {limit}. הסירו מכשירים מהרשימה עד לעמידה במגבלה.",
    retry: "ניסיון חוזר",
    switchStudent: "החלפת משתמש AAC",
    loadFailed: "טעינת המכשירים נכשלה.",
  },

  auth: {
    selectStudent: "בחירת משתמש AAC",
    loggedInAs: "מחובר כ",
    loadingStudents: "טוען משתמשי AAC...",
    failedToLoadStudents: "טעינת משתמשי AAC נכשלה. נסה שוב.",
    noStudentsFound: "לא נמצאו משתמשי AAC.",
    addStudentHint: "נא להוסיף משתמש AAC באפליקציית CliniAACian תחילה.",
    chooseStudent: "בחר משתמש AAC להתחלה",
    ...
    noClassroom: "ללא כיתה (משתמש AAC יחיד)",
    noStudentsInClassroom: "אין משתמשי AAC בכיתה זו.",
    loggingOut: "מתנתק...",
    loginTitle: "ברוך הבא",
  ...
  settings: {
    ...
    studentVoice: "קול משתמש ה-AAC",
    aiVoice: "קול הבינה המלאכותית",
    studentVoiceHint: "הקול המשמש לדיבור מילות משתמש ה-AAC",
    aiVoiceHint: "הקול המשמש כשהבינה המלאכותית מגיבה",
    customStudentVoice: "קול מותאם אישית למשתמש ה-AAC",
    customStudentVoiceHint: "קול ElevenLabs מותאם עבור משתמש ה-AAC (עוקף את סוג הקול הבסיסי)",
    ...
    geminiVoiceDesc: "בחר קולות לשיחת AI בזמן אמת. ברירות המחדל מבוססות על מגדר משתמש ה-AAC.",
    ...
    elevenlabsStudentVoiceId: "מזהה קול משתמש ה-AAC",
  ...
  aacSettings: {
    ...
    aiNameDesc: "תן לעוזר ה-AI שם שמשתמש ה-AAC יוכל להשתמש בו",
  ...
  errors: {
    ...
    CONSENT_REQUIRED: "לא ניתן להתחיל מפגשים עד להשלמת טופס ההסכמה של משתמש ה-AAC. יש לבקש מקלינאי להשלים את אשף ההסכמה.",
    MESSAGE_REQUIRED: "נדרשת הודעה.",
    MESSAGE_FAILED: "עיבוד ההודעה נכשל.",
    NO_AUDIO: "לא סופק קובץ שמע.",
    VOICE_FAILED: "עיבוד הקלט הקולי נכשל.",
    STUDENT_ID_REQUIRED: "נדרש מזהה משתמש AAC.",
