...
export const GAMES: GameEntry[] = [
  {
    id: "space-trader",
    name: "Space Trader",
    description: "Steer your ship through asteroids and trade with merchants. Find the Spiral to win.",
    emoji: "🚀",
  ...
  },
  {
    id: "sandbox-game",
    name: "Sandbox Farm",
    description: "Plant seeds, harvest crops, and watch your idle farm grow over time.",
    emoji: "🌱",
  ...
  },
  {
    id: "bubbles-game",
    name: "Bubbles",
    description: "Tap or click to pop floating bubbles. A friendly reflex game.",
    emoji: "🫧",
