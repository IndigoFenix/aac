...
import { buildSkeleton, limbTip } from "./skeleton";
import {
  FRUIT_PLACEMENTS,
  GROWTH_ATTACH,
...
import { bakePlantImpostor, buildPlantLods, makeImpostorMesh, plantMaterial } from "./plant-lod";
import { CREATURE_EXAMPLES } from "./examples";
import { DEFAULT_GAIT, GAIT_PATTERNS, type GaitParams, type GaitPattern } from "./gait";
import { CreatureAnimator, type AnimFrame } from "./animation";
