...
const VOCAB: VocabularyItem[] = [
  ...
  { key: "turtle", tKey: "aac.glyph.turtle", pos: "animal", categories: ["who"],
    modeChips: { who: ["all", "animals"] }, tone: "comment", emoji: "🐢" },
  // THE ANIMAL VOCABULARY (2026-08-27) — the rest of the creatures a child
  // names, ordered most-said first. Each has a species row of its own
  // (creatures/species.ts, most as `stub`: the word ships ahead of the body
  // plan), which is what puts it behind the sentence builder's [animals] chip;
  // this row is its picture and its eleven translations.
  // `hen` and not "chicken": `chicken` is already the FOOD (🍗), and one key
  // may name one referent.
  { key: "hen", tKey: "aac.glyph.hen", pos: "animal", categories: ["who"],
    modeChips: { who: ["all", "animals"] }, tone: "comment", emoji: "🐔" },
  { key: "mouse", tKey: "aac.glyph.mouse", pos: "animal", categories: ["who"],
    modeChips: { who: ["all", "animals"] }, tone: "comment", emoji: "🐭" },
  { key: "tiger", tKey: "aac.glyph.tiger", pos: "animal", categories: ["who"],
    modeChips: { who: ["all", "animals"] }, tone: "comment", emoji: "🐯" },
  { key: "bee", tKey: "aac.glyph.bee", pos: "animal", categories: ["who"],
    modeChips: { who: ["all", "animals"] }, tone: "comment", emoji: "🐝" },
  { key: "goat", tKey: "aac.glyph.goat", pos: "animal", categories: ["who"],
    modeChips: { who: ["all", "animals"] }, tone: "comment", emoji: "🐐" },
  { key: "owl", tKey: "aac.glyph.owl", pos: "animal", categories: ["who"],
    modeChips: { who: ["all", "animals"] }, tone: "comment", emoji: "🦉" },
  { key: "penguin", tKey: "aac.glyph.penguin", pos: "animal", categories: ["who"],
    modeChips: { who: ["all", "animals"] }, tone: "comment", emoji: "🐧" },
  { key: "giraffe", tKey: "aac.glyph.giraffe", pos: "animal", categories: ["who"],
    modeChips: { who: ["all", "animals"] }, tone: "comment", emoji: "🦒" },
  { key: "zebra", tKey: "aac.glyph.zebra", pos: "animal", categories: ["who"],
    modeChips: { who: ["all", "animals"] }, tone: "comment", emoji: "🦓" },
  { key: "panda", tKey: "aac.glyph.panda", pos: "animal", categories: ["who"],
    modeChips: { who: ["all", "animals"] }, tone: "comment", emoji: "🐼" },
  { key: "fox", tKey: "aac.glyph.fox", pos: "animal", categories: ["who"],
    modeChips: { who: ["all", "animals"] }, tone: "comment", emoji: "🦊" },
  { key: "wolf", tKey: "aac.glyph.wolf", pos: "animal", categories: ["who"],
    modeChips: { who: ["all", "animals"] }, tone: "comment", emoji: "🐺" },
  { key: "squirrel", tKey: "aac.glyph.squirrel", pos: "animal", categories: ["who"],
    modeChips: { who: ["all", "animals"] }, tone: "comment", emoji: "🐿️" },
  { key: "whale", tKey: "aac.glyph.whale", pos: "animal", categories: ["who"],
    modeChips: { who: ["all", "animals"] }, tone: "comment", emoji: "🐳" },
  { key: "dolphin", tKey: "aac.glyph.dolphin", pos: "animal", categories: ["who"],
    modeChips: { who: ["all", "animals"] }, tone: "comment", emoji: "🐬" },
  { key: "shark", tKey: "aac.glyph.shark", pos: "animal", categories: ["who"],
    modeChips: { who: ["all", "animals"] }, tone: "comment", emoji: "🦈" },
  { key: "crab", tKey: "aac.glyph.crab", pos: "animal", categories: ["who"],
    modeChips: { who: ["all", "animals"] }, tone: "comment", emoji: "🦀" },
  { key: "octopus", tKey: "aac.glyph.octopus", pos: "animal", categories: ["who"],
    modeChips: { who: ["all", "animals"] }, tone: "comment", emoji: "🐙" },
  { key: "snail", tKey: "aac.glyph.snail", pos: "animal", categories: ["who"],
    modeChips: { who: ["all", "animals"] }, tone: "comment", emoji: "🐌" },
  { key: "spider", tKey: "aac.glyph.spider", pos: "animal", categories: ["who"],
    modeChips: { who: ["all", "animals"] }, tone: "comment", emoji: "🕷️" },
  { key: "ant", tKey: "aac.glyph.ant", pos: "animal", categories: ["who"],
    modeChips: { who: ["all", "animals"] }, tone: "comment", emoji: "🐜" },
  { key: "ladybug", tKey: "aac.glyph.ladybug", pos: "animal", categories: ["who"],
    modeChips: { who: ["all", "animals"] }, tone: "comment", emoji: "🐞" },
  { key: "koala", tKey: "aac.glyph.koala", pos: "animal", categories: ["who"],
    modeChips: { who: ["all", "animals"] }, tone: "comment", emoji: "🐨" },
  { key: "kangaroo", tKey: "aac.glyph.kangaroo", pos: "animal", categories: ["who"],
    modeChips: { who: ["all", "animals"] }, tone: "comment", emoji: "🦘" },
  { key: "camel", tKey: "aac.glyph.camel", pos: "animal", categories: ["who"],
    modeChips: { who: ["all", "animals"] }, tone: "comment", emoji: "🐫" },
  { key: "crocodile", tKey: "aac.glyph.crocodile", pos: "animal", categories: ["who"],
    modeChips: { who: ["all", "animals"] }, tone: "comment", emoji: "🐊" },
  { key: "lizard", tKey: "aac.glyph.lizard", pos: "animal", categories: ["who"],
    modeChips: { who: ["all", "animals"] }, tone: "comment", emoji: "🦎" },
  { key: "parrot", tKey: "aac.glyph.parrot", pos: "animal", categories: ["who"],
    modeChips: { who: ["all", "animals"] }, tone: "comment", emoji: "🦜" },
  { key: "gorilla", tKey: "aac.glyph.gorilla", pos: "animal", categories: ["who"],
    modeChips: { who: ["all", "animals"] }, tone: "comment", emoji: "🦍" },
  { key: "hippo", tKey: "aac.glyph.hippo", pos: "animal", categories: ["who"],
    modeChips: { who: ["all", "animals"] }, tone: "comment", emoji: "🦛" },
  { key: "rhino", tKey: "aac.glyph.rhino", pos: "animal", categories: ["who"],
    modeChips: { who: ["all", "animals"] }, tone: "comment", emoji: "🦏" },
  { key: "worm", tKey: "aac.glyph.worm", pos: "animal", categories: ["who"],
    modeChips: { who: ["all", "animals"] }, tone: "comment", emoji: "🪱" },
  ...
  { key: "tree", tKey: "aac.glyph.tree", pos: "noun", categories: ["what"],
    modeChips: { what: ["all", "nature"] }, tone: "comment", emoji: "🌳" },
  // THE PLANT VOCABULARY (2026-08-27) — filed beside `tree` under the nature
  // chip, and behind the sentence builder's [plants] chip via their species
  // rows (`kind: "plant"`). Growing things, not the produce: the fruit and the
  // vegetables are food and keep their own rows.
  { key: "grass", tKey: "aac.glyph.grass", pos: "noun", categories: ["what"],
    modeChips: { what: ["all", "nature"] }, tone: "comment", emoji: "🌿" },
  { key: "leaf", tKey: "aac.glyph.leaf", pos: "noun", categories: ["what"],
    modeChips: { what: ["all", "nature"] }, tone: "comment", emoji: "🍃" },
  { key: "rose", tKey: "aac.glyph.rose", pos: "noun", categories: ["what"],
    modeChips: { what: ["all", "nature"] }, tone: "comment", emoji: "🌹" },
  { key: "sunflower", tKey: "aac.glyph.sunflower", pos: "noun", categories: ["what"],
    modeChips: { what: ["all", "nature"] }, tone: "comment", emoji: "🌻" },
  { key: "tulip", tKey: "aac.glyph.tulip", pos: "noun", categories: ["what"],
    modeChips: { what: ["all", "nature"] }, tone: "comment", emoji: "🌷" },
  { key: "daisy", tKey: "aac.glyph.daisy", pos: "noun", categories: ["what"],
    modeChips: { what: ["all", "nature"] }, tone: "comment", emoji: "🌼" },
  { key: "cactus", tKey: "aac.glyph.cactus", pos: "noun", categories: ["what"],
    modeChips: { what: ["all", "nature"] }, tone: "comment", emoji: "🌵" },
  { key: "mushroom", tKey: "aac.glyph.mushroom", pos: "noun", categories: ["what"],
    modeChips: { what: ["all", "nature"] }, tone: "comment", emoji: "🍄" },
  { key: "pine_tree", tKey: "aac.glyph.pine_tree", pos: "noun", categories: ["what"],
    modeChips: { what: ["all", "nature"] }, tone: "comment", emoji: "🌲" },
  { key: "palm_tree", tKey: "aac.glyph.palm_tree", pos: "noun", categories: ["what"],
    modeChips: { what: ["all", "nature"] }, tone: "comment", emoji: "🌴" },
