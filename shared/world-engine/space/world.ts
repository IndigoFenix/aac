...
export function createWorld(
  ...
  opts: {
    /** PLANET COMPRESSION (space-time-compression.md §5): every system this
     *  world materializes is miniature by this factor — radii ÷ s, orbits ÷ s,
     *  surface gravity preserved. Star-to-star distances stay real (the
     *  galaxy is not the compressed feature; its planets are). */
    compression?: number;
  } = {},
): StreamingWorld {
