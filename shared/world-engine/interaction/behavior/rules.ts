 ...
 *  world layer maps it onto the placement search (near ⇒ beside the anchor).
 *  Scope-agnostic: the same vocabulary later parameterizes city-scale build
 *  orders ("build house near well"). */
export type PlacementRel = "in" | "on" | "near" | "under" | "over" | "behind" | "front" | "at";
