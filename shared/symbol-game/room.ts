...
import type { NpcMovement, NpcSpec, ObjectSpec, Vec2, WorldSpec } from "../world-engine/types.js";
import { WORLD_MAX_NPCS, WORLD_MAX_OBJECTS } from "../world-engine/types.js";
import { certifyWorldSpec } from "../world-engine/index.js";
import type { PoolDef, PoolId, PoolMember } from "./types.js";
import { materializesAsNpc, objectConfigForAffordance } from "./affordance.js";
import { randomMemberPicker, type MemberPicker } from "./quote.js";
