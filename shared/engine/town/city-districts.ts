 ...
 *  market) and unknown types. The standard classifier over a game's
 *  default registry lives with that game's content (grand-dream
 *  city-districts.ts `defaultWorkClass`). */
export type WorkClass = "farm" | "mining" | "craft" | null;
