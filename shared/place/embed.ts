...
import { projectContentOnZones } from "../goal-tree/projector2d.js";
import { START_ZONE_ID } from "../goal-tree/logical-world.js";
import type {
  LogicalWorld,
  PassageGuard,
  ZoneKind,
  ZoneSpec,
} from "../goal-tree/logical-world.js";
import type { DoorLayout, Layout2D, Rect as LRect } from "../goal-tree/layout2d.js";
import type { GoalTreeGame } from "../goal-tree/types.js";
import type { BuildingDoorway, BuildingSpec } from "../world-engine/types.js";
import { KIND_CATEGORY } from "../symbol-game/pools.js";
